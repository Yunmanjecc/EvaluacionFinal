            ...
            public void onMapReady(GoogleMap map) {
                ...
                ubicacion.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (ActivityCompat.checkSelfPermission(juan.clemente.primerainterfaz.ubicacion.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                                ActivityCompat.checkSelfPermission(juan.clemente.primerainterfaz.ubicacion.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                            // Solicitar permisos si no se tienen
                            ActivityCompat.requestPermissions(juan.clemente.primerainterfaz.ubicacion.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, PERMISSION_REQUEST_LOCATION);
                            return;
                        }
                        ...
                        FusedLocationProviderClient fusedLocationClient = LocationServices.getFusedLocationProviderClient(juan.clemente.primerainterfaz.ubicacion.this);
                        fusedLocationClient.getLastLocation().addOnSuccessListener(juan.clemente.primerainterfaz.ubicacion.this, new OnSuccessListener<Location>() {
                            @Override
